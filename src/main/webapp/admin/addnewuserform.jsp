...
<body>
	<div class="container mt-5">
		<h2>Add User</h2>
		<form action="addnewuser" method="post" name="mainform" id="mainform"
			...
			<div>
				<c:if test="${loginError != null}">
					<p style="color: red">Invalid value: ${loginError[0]};
						${loginError[1]}</p>
				</c:if>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="password" class="form-control"
						placeholder="Enter Password again" name="confpass" required>
				</div>
			</div>
